...
require_once $_SERVER['DOCUMENT_ROOT'] . '/spil.controller/NotificationController.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/spil.model/NotificationModelImpl.php';
require_once $_SERVER['DOCUMENT_ROOT'] . '/spil.model/spil.model.entity/NotificationImpl.php';
