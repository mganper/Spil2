...
require_once $_SERVER['DOCUMENT_ROOT'] . '/spil.controller/SpilController.php';

require_once $_SERVER['DOCUMENT_ROOT'] . '/spil.model/SpilModelImpl.php';

require_once $_SERVER['DOCUMENT_ROOT'] . '/spil.model/spil.model.entity/SpilImpl.php';
